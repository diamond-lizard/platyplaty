"""Truncation for files with size indicators (middle pane).

This module provides the function to truncate file names when they are
displayed with right-justified size indicators in the middle pane.
The size indicator is always preserved except at extreme widths.
"""
