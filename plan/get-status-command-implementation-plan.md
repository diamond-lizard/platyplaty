...
| TASK-3300 | In GET_STATUS case: Create `nlohmann::json data` object with fields: `data["audio_source"] = audio.get_source()`, `data["audio_connected"] = audio.is_connected()`, `data["preset_path"] = viz.get_current_preset_path()`, `data["visible"] = win.is_visible()`, `data["fullscreen"] = win.is_fullscreen()` | Yes | 2025-12-27 |
