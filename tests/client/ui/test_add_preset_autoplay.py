#!/usr/bin/env python3
"""Tests for auto-play behavior when adding presets to playlist.

This module tests the autoplay behavior when adding presets via
the 'a' key in the file browser section.
"""
...
class TestAutoplayOnAdd:
    ...
    async def test_adding_to_empty_playlist_triggers_autoplay(
        ...
        with patch("platyplaty.ui.file_browser_actions.is_readable", return_value=True):
            with patch("platyplaty.ui.file_browser_actions.autoplay_first_preset") as mock_auto:
